<template>
  <div class="c_container c_rela">
    ...
    <div class="c_flex c_flex_center route c_no_pointer">
      ...
      <el-button v-show="!drawer.visible" class="particlesSet c_all_pointer" type="info" icon="el-icon-set-up" circle @click="drawer.visible=!drawer.visible"></el-button>
    </div>
    ...
    <el-drawer
      ...
      <el-form ref="form" class="c_auto" label-width="150px">
        ...
        <el-form-item label="粒子透明度">
          <el-input-number v-model="particles.particleOpacity" controls-position="right" :min="0" :max="1" :precision="1" :step="0.1"></el-input-number>
        </el-form-item>
        <el-form-item label="粒子数量">
          <el-input-number v-model="particles.particlesNumber" controls-position="right" :min="0" :max="100"></el-input-number>
        </el-form-item>
        ...
        <el-form-item label="线条透明度" v-show="particles.lineLinked">
          <el-input-number v-model="particles.lineOpacity" controls-position="right" :min="0" :max="1" :precision="1" :step="0.1"></el-input-number>
        </el-form-item>
