    ...
    if(!Cset.set.log.disabled){
      switch (type){
        ...
        case 'info':
          console.info(msg);
        case 'color':
          console.log('%c '+ msg , styleCss||"background:linear-gradient(to right, red, purple;-webkit-background-clip: text;color: white;");
      }
      console.log(msg);
    }
  },
